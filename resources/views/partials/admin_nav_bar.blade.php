  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="{{ url('/admin/page') }}">Pages <span class="sr-only">(current)</span></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="{{ url('/admin/catalog/product') }}">Products</a></li>
            <li><a href="{{ url('/admin/catalog/category') }}">Categories</a></li>
